...
var f = (function (){var pred__27753 = cljs.core._EQ_;
var expr__27754 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27753.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27754))){
return ((function (pred__27753,expr__27754){
return (function (p1__27747_SHARP_){
return console.warn(p1__27747_SHARP_);
});
;})(pred__27753,expr__27754))
} else {
if(cljs.core.truth_(pred__27753.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27754))){
return ((function (pred__27753,expr__27754){
...
if(cljs.core.truth_(pred__27753.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27754))){
return ((function (pred__27753,expr__27754){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27757){
...
var opts = map__27758__$1;
var eval_fn = cljs.core.get.call(null,map__27758__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27760_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27762,(0),null);
...
}catch (e27767){if((e27767 instanceof Error)){
var e = e27767;
return not_found;
} else {
throw e27767;
...
//# sourceMappingURL=utils.js.map?rel=1522769332509
