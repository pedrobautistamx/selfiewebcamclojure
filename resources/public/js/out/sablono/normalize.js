...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__21659){
var vec__21660 = p__21659;
var _ = cljs.core.nth.call(null,vec__21660,(0),null);
var v = cljs.core.nth.call(null,vec__21660,(1),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__21663_SHARP_){
return (((p1__21663_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__21663_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__21664,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__21664;
}
});
...
var len__4499__auto___21667 = arguments.length;
var i__4500__auto___21668 = (0);
while(true){
if((i__4500__auto___21668 < len__4499__auto___21667)){
args__4502__auto__.push((arguments[i__4500__auto___21668]));

var G__21669 = (i__4500__auto___21668 + (1));
i__4500__auto___21668 = G__21669;
continue;
} else {
}
break;
...
var G__21666 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__21666,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__21666;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq21665){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21665));
});
...
var vec__21672 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__21672,(0),null);
var names = cljs.core.nth.call(null,vec__21672,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__21672,tag_name,names){
return (function (p1__21670_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__21670_SHARP_))){
return p1__21670_SHARP_;
} else {
return null;
}
});})(matches,vec__21672,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__21672,tag_name,names){
return (function (p1__21671_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__21671_SHARP_));
});})(matches,vec__21672,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__21675){
var vec__21676 = p__21675;
var seq__21677 = cljs.core.seq.call(null,vec__21676);
var first__21678 = cljs.core.first.call(null,seq__21677);
var seq__21677__$1 = cljs.core.next.call(null,seq__21677);
var tag = first__21678;
var content = seq__21677__$1;
...
var vec__21679 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21679,(0),null);
var id = cljs.core.nth.call(null,vec__21679,(1),null);
var class$ = cljs.core.nth.call(null,vec__21679,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1522772864088
