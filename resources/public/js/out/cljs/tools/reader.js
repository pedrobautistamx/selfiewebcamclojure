...
var G__23017 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__23017;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__23018 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23018,ch);
...
if(("\\" === ch__$1)){
var ch_23019__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_23019__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_23019__$2);
} else {
}

var G__23020 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__23020;
continue;
}
}
...
var G__23031 = cljs.core.conj_BANG_.call(null,a,form);
a = G__23031;
continue;
}
}
...
var _STAR_read_delim_STAR_23032 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_23032;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__23033 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23033,(0),null);
var start_column = cljs.core.nth.call(null,vec__23033,(1),null);
...
var vec__23036 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23036,(0),null);
var end_column = cljs.core.nth.call(null,vec__23036,(1),null);
...
var vec__23039 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__23042 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23042,(0),null);
var end_column = cljs.core.nth.call(null,vec__23042,(1),null);
...
var vec__23045 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__23048 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23048,(0),null);
var end_column = cljs.core.nth.call(null,vec__23048,(1),null);
...
var sb = (function (){var G__23051 = (new goog.string.StringBuffer());
G__23051.append(initch);
...
var G__23053 = (function (){var G__23052 = sb;
G__23052.append(ch);

return G__23052;
})();
var G__23054 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__23053;
ch = G__23054;
continue;
}
...
switch (G__23057) {
case "\\":
var G__23061 = (function (){var G__23058 = sb;
G__23058.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__23058;
})();
var G__23062 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23061;
ch = G__23062;
continue;
...
break;
default:
var G__23063 = (function (){var G__23059 = sb;
G__23059.append(ch);

return G__23059;
})();
var G__23064 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23063;
ch = G__23064;
continue;
...
var vec__23068 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23068,(0),null);
var column = cljs.core.nth.call(null,vec__23068,(1),null);
...
var line = cljs.core.nth.call(null,vec__23073,(0),null);
var column = cljs.core.nth.call(null,vec__23073,(1),null);
...
var line = cljs.core.nth.call(null,vec__23078,(0),null);
var column = cljs.core.nth.call(null,vec__23078,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__23083 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23083,(0),null);
var start_column = cljs.core.nth.call(null,vec__23083,(1),null);
...
var vec__23086 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23086,(0),null);
var end_column = cljs.core.nth.call(null,vec__23086,(1),null);
...
var G__23089 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__23089,true,null,opts,pending_forms);
...
var G__23090 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__23090)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__23090)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__23090)){
...
var _STAR_suppress_read_STAR_23091 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_23091;
}});
...
var G__23092 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__23092,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__23092,rdr,first_line);
...
var G__23096 = matched;
var G__23097 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__23096;
finished = G__23097;
continue;
} else {
...
var _STAR_suppress_read_STAR_23098 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_23098;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env23099 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__23100 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23100,"(");
...
var G__23101 = (i + (1));
var G__23102 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env23099;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__23103 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__23103);
...
var G__23104 = cljs.core.next.call(null,s__$1);
var G__23105 = ret;
s__$1 = G__23104;
r = G__23105;
continue;
...
var G__23106 = cljs.core.next.call(null,s);
var G__23107 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__23106;
key_vals = G__23107;
continue;
} else {
...
var gensym_env23111 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env23111;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__23112 = token;
var G__23112__$1 = (((G__23112 == null))?null:cljs.core.subs.call(null,G__23112,(1)));
var G__23112__$2 = (((G__23112__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23112__$1));
var G__23112__$3 = (((G__23112__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23112__$2));
var G__23112__$4 = (((G__23112__$3 == null))?null:cljs.core.symbol.call(null,G__23112__$3));
if((G__23112__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__23112__$4);
}
})():(function (){var G__23113 = token;
var G__23113__$1 = (((G__23113 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23113));
if((G__23113__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23113__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e23120){if((e23120 instanceof Error)){
var e = e23120;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__23124,reader){
...
var opts = map__23125__$1;
var eof = cljs.core.get.call(null,map__23125__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___23133 = arguments.length;
var i__4500__auto___23134 = (0);
while(true){
if((i__4500__auto___23134 < len__4499__auto___23133)){
args__4502__auto__.push((arguments[i__4500__auto___23134]));

var G__23135 = (i__4500__auto___23134 + (1));
i__4500__auto___23134 = G__23135;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq23131){
var G__23132 = cljs.core.first.call(null,seq23131);
var seq23131__$1 = cljs.core.next.call(null,seq23131);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23132,seq23131__$1);
});


//# sourceMappingURL=reader.js.map?rel=1522769328868
