...
goog.addDependency("../cljsjs/react-with-addons/development/react-with-addons.inc.js", ['cljsjs.react'], [], {'foreign-lib': true});
...
goog.addDependency("../re_mdl/util.js", ['re_mdl.util'], ['reagent.core', 'cljs.core']);
goog.addDependency("../re_mdl/components/layout.js", ['re_mdl.components.layout'], ['re_mdl.util', 'cljs.core']);
goog.addDependency("../re_mdl/components/toggle.js", ['re_mdl.components.toggle'], ['re_mdl.util', 'reagent.core', 'cljs.core']);
goog.addDependency("../cljsjs/material/development/material.inc.js", ['cljsjs.material'], [], {'foreign-lib': true});
goog.addDependency("../re_mdl/components/dialog.js", ['re_mdl.components.dialog'], ['re_mdl.util', 'cljs.core']);
goog.addDependency("../re_mdl/components/loading.js", ['re_mdl.components.loading'], ['re_mdl.util', 'reagent.core', 'cljs.core']);
goog.addDependency("../re_mdl/components/snackbar.js", ['re_mdl.components.snackbar'], ['re_mdl.util', 'cljs.core']);
goog.addDependency("../re_mdl/components/slider.js", ['re_mdl.components.slider'], ['re_mdl.util', 'reagent.core', 'cljs.core']);
goog.addDependency("../re_mdl/components/tooltip.js", ['re_mdl.components.tooltip'], ['re_mdl.util', 'cljs.core']);
goog.addDependency("../re_mdl/components/chip.js", ['re_mdl.components.chip'], ['cljs.core']);
goog.addDependency("../re_mdl/components/table.js", ['re_mdl.components.table'], ['re_mdl.util', 'cljs.core']);
goog.addDependency("../re_mdl/components/menu.js", ['re_mdl.components.menu'], ['re_mdl.util', 'cljs.core']);
goog.addDependency("../re_mdl/components/list.js", ['re_mdl.components.list'], ['cljs.core']);
goog.addDependency("../re_mdl/components/button.js", ['re_mdl.components.button'], ['re_mdl.util', 'cljs.core']);
